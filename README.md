...
- *try_threshold_ecdsa.py*: this function simulates an ECDSA-based threshold digital signature. The secp256k1 elliptic curve is used in the simulation, the number of nodes $n$ is 10 and the threshold $t$ is 7. The algorithm used involves the following steps:
