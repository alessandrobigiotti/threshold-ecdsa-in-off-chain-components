...
![alt text](https://github.com/alessandrobigiotti/threshold-ecdsa-in-off-chain-components/tree/main/img/img.png)

## Optimised Elliptic Curve Operations

The Table shows the gas consumed by individual operations on each elliptic curve indicated. The performance of the proposed library, *EllipticCurveMath.sol*, was compared to other open source implementations found on Githhub. The symbol "-" means "Not applicable" and the symbol $X$ means "Operation not provided".
